...
public class ItemData {
    ...
    public static int ThinhLuyenParam(final int id, final int tl) {
        switch (id) {
            case 76: {//Tăng tấn công cho chủ
                return (tl != 8) ? ((tl != 7) ? ((tl != 6) ? ((tl != 5) ? ((tl != 4) ? ((tl != 3) ? ((tl != 2) ? ((tl != 1) ? ((tl != 0) ? 0 : 50) : 60) : 70) : 90) : 130) : 180) : 250) : 350) : 500;
            }
            case 77: {//Tăng max HP cho chủ
                return (tl != 8) ? ((tl != 7) ? ((tl != 6) ? ((tl != 5) ? ((tl != 4) ? ((tl != 3) ? ((tl != 2) ? ((tl != 1) ? ((tl != 0) ? 0 : 40) : 60) : 80) : 100) : 140) : 220) : 300) : 420) : 590;
            }
            case 75:
            case 78: {
            ...
            case 79: {
                return (tl != 8) ? ((tl != 7) ? ((tl != 6) ? ((tl != 5) ? ((tl != 4) ? ((tl != 3) ? ((tl != 2) ? ((tl != 1) ? ((tl != 0) ? 0 : 1) : 1) : 2) : 2) : 2) : 2) : 3) : 3) : 4;
            }
            case 80: {
                return (tl != 8) ? ((tl != 7) ? ((tl != 6) ? ((tl != 5) ? ((tl != 4) ? ((tl != 3) ? ((tl != 2) ? ((tl != 1) ? ((tl != 0) ? 0 : 5) : 7) : 9) : 11) : 13) : 15) : 20) : 25) : 30;
            }
            case 81: {
                return (tl != 8) ? ((tl != 7) ? ((tl != 6) ? ((tl != 5) ? ((tl != 4) ? ((tl != 3) ? ((tl != 2) ? ((tl != 1) ? ((tl != 0) ? 0 : 5) : 5) : 5) : 5) : 10) : 10) : 10) : 15) : 20;
            }
            case 82:
            case 83: {
                return (tl != 8) ? ((tl != 7) ? ((tl != 6) ? ((tl != 5) ? ((tl != 4) ? ((tl != 3) ? ((tl != 2) ? ((tl != 1) ? ((tl != 0) ? 0 : 40) : 60) : 80) : 100) : 140) : 220) : 300) : 420) : 590;
    ...
    public static Item itemDefault(final int id) {
        ...
        if (id >= 652 && id <= 655) {
            ...
            if (id == HAI_MA_1_ID || id == DI_LONG_1_ID) {
                item.option.add(new Option(ST_NGUOI_ID, 3600));
                item.option.add(new Option(ST_QUAI_ID, 6000));
            } else if (id == HAI_MA_2_ID || id == DI_LONG_2_ID) {
                item.option.add(new Option(ST_NGUOI_ID, 4800));
                item.option.add(new Option(ST_QUAI_ID, 20000));
            } else if (id == HAI_MA_3_ID || id == DI_LONG_3_ID) {
                item.option.add(new Option(ST_NGUOI_ID, 7200));
                item.option.add(new Option(ST_QUAI_ID, 36000));
            }
            return item;
    ...
    public static short[] getItemIdByLevel(int maxLevel, byte type, byte gender) {
        ...
        for (ItemData item : entrys.values()) {
            ...
            if (!item.name.toLowerCase().contains("jirai") && !item.name.toLowerCase().contains("jumito") && item.id < 638) {
    ...
    public static int MAX_ST_NGUOI = 500;
    public static int HP_TOI_DA = 55;
    public static int MP_TOI_DA = 55;
    public static int CHI_MANG = 10;
    ...
    public static Item itemNgocDefault(int id, int upgrade, boolean random) {
        ...
        if (id == HUYET_NGOC) {
            ...
            item.option.add(new Option(115,  NE_DON));
        ...
        if (id == LAM_TINH_NGOC) {
            ...
            item.option.add(new Option(103,  MAX_ST_NGUOI));
            item.option.add(new Option(125, -(random ? util.nextInt((int) (0.8 * HP_TOI_DA), HP_TOI_DA) : HP_TOI_DA)));

            item.option.add(TRANG_BI_OPTION);
            item.option.add(new Option(121,  KHANG_ST_CHI_MANG));
            ...
            item.option.add(TRANG_SUC_OPTION);
            item.option.add(new Option(116,  CHINH_XAC));
        ...
        if (id == LUC_NGOC) {
            ...
            item.option.add(new Option(105,  ST_CHI_MANG));
            item.option.add(new Option(116, -(random ? util.nextInt((int) (2 * CHINH_XAC), CHINH_XAC) : CHINH_XAC)));

            item.option.add(TRANG_BI_OPTION);
            item.option.add(new Option(125,  HP_TOI_DA));
            item.option.add(new Option(117, -(random ? util.nextInt((int) (0.8 * MP_TOI_DA), MP_TOI_DA) : MP_TOI_DA)));

            item.option.add(TRANG_SUC_OPTION);
            item.option.add(new Option(117,  MP_TOI_DA));
