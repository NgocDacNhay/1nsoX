...
//            p.sendInfo(false);
//        }
        if ((item.id >= 795 && item.id <= 805) || (item.id >= 813 && item.id <= 817) || (item.id >= 825 && item.id <= 827) || (item.id >= 830 && item.id <= 832) || item.id >= 0 && ItemData.ItemDataId(item.id).type != 27 && ItemData.ItemDataId(item.id).type != 34) {
