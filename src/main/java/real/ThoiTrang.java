...
public class ThoiTrang {
    ...
    public static void setThoiTrang(Ninja nj, short templateId) {
        switch (templateId) {
            case 903: {
    ...
    public static void removeThoiTrang(Ninja nj, short templateId) {
        switch (templateId) {       
            case 903:
            case 904:
            case 895:
    ...
    public static void setThoiTrangPT(CloneChar _cl, short templateId) {
        switch (templateId) {
            case 903: {
    ...
    public static void removeThoiTrangPT(CloneChar _cl, short templateId) {
        switch (templateId) {
            case 903:
            case 904:
            case 895:
